...
function loadExtra(){
  ...
  const wanted=['/sellb2-enhancements.js?v=sellb2-23','/sellb2-category-fix.js?v=sellb2-23','/sellb2-navigation-fix.js?v=sellb2-24','/sellb2-navigation-hotfix.js?v=sellb2-25'];
  wanted.forEach(src=>{
